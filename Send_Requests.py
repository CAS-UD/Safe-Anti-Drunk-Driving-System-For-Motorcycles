...
class SendRequest:
    ...
    def __init__(self, url, bno055_scl_pinCon, bno055_sda_pinCon, data_number_control, tx_pinCon, time_zone):

        self.url = url
        self.dat = Data_management.DataManagement(bno055_scl_pinCon, bno055_sda_pinCon, data_number_control, tx_pinCon, time_zone)    
